...
class ImageSelectorControl extends Base_Data_Control {
	 ...
	 * @var string
	 */
	public static $controlName = 'advanced-news-ticker-image-select';
	...
	public function content_template() {
        ...
        <div class="elementor-control-field">
            ...
            <div class="elementor-control-image-selector-wrapper">
                ...
                <div class="image-selector-inner{{ options.is_pro ? ' advanced-news-ticker-pro' : '' }}" title="{{ ! options.is_pro ? '' : 'Upgrade to PRO!' }}" data-tooltip="{{ ! options.is_pro ? options.title : 'Upgrade to PRO!' }}">
